...
class Usuarios
{
    ...
    function up()
    {
        \DBUtil::create_table('usuarios', array(
            ...
            'usuario' => array('type' => 'varchar', 'constraint' => 100),
            'contraseña' => array('type' => 'varchar', 'constraint' => 200),
            ...
            'cumpleaños' => array('type' => 'varchar', 'constraint' => 20, 'null' => true),
        ...
        \DB::query("ALTER TABLE `usuarios` ADD UNIQUE (`usuario`)")->execute();
